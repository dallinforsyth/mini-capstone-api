...
class ProductsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "show" do
    ...
    data = JSON.parse(response.body)
    assert_equal ["id", "name", "price", "is_discounted?", "tax", "total", "image_url", "description", "inventory", "created_at", "updated_at"], data.keys
  end
  ...
  test "update" do
    ...
    assert_equal product.inventory, data["inventory"]
  end
